   ...
   'use strict'
	...
	var responsiveMenu = function() {
		...
		$(window).on('load resize', function() {
			...
			/*changed resolution for mobile*/
			/*if ( matchMedia( 'only screen and (max-width: 1024px)' ).matches ) {*/			if ( matchMedia( 'only screen and (max-width: 880px)' ).matches ) {
				currMenuType = 'mobile';
			}
			...
			if ( currMenuType !== menuType ) {
				...
				if ( currMenuType === 'mobile' ) {
					...
					/*$('#mainnav-mobi').width($(window).width());*/
