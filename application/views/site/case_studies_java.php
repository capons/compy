...
<head lang="en">
    ...
    <title>Case Studies - Java – Computools</title>
...
<h1 style="display: none;">Case Studies - Java – Computools</h1><!--For SEO-->
<div class="caseStudies ">
    <div class="containerWidth">
        <ul class="caseStudiesList">
            <li>
                <a href="java/audio-task-manager">
                    <div class="caseContent">
                        <div class="hover">
                            <div>
                                <div class="alignCase">
                                    <div>
                                        New project for composers and clients.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <img src="<?=template_url('img');?>case13.jpg" alt="case image"/>
                    </div>
                </a>
            </li>
            <li>
                <a href="java/aggregator-of-the-news-videos">
                    <div class="caseContent">
                        <div class="hover">
                            <div>
                                <div class="alignCase">
                                    <div>
                                        Aggregator of the news videos from different sources.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <img src="<?=template_url('img');?>case27.jpg" alt="Aggregator of the news videos - Case Computools"/>
                    </div>
                </a>
            </li>
        </ul>
        ...
        <div class="containerWidth">
            ...
            <form method="post" action="#modal-one" enctype="multipart/form-data">
                <div class="contactForm bottom">
                    ...
                    <input type="hidden" name="marker" value="http://computoolsglobal.com/case-studies/java#form">
