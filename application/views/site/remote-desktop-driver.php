    ...
    <div class="align">
        <div class="caseContainer">
            ...
            <ul class="caseUl caseUlRdd">
                <li class="imgFromLeft"><img src="<?=template_url('img');?>cases/Mac.png" alt="case image"/></li>
                ...
                <li>
                    ...
                    <div class="alignRddRight">
                        ...
                        <div class="caseText" style="text-align: right">
                            ...
                            Qt development environment has been chosen. Qt is the
                            cross-platform Software development tool in the programming
                            language C++. Qt environment allowed us to speed up the
                            development and simplified the application’s adaptation process
                            for each Operating System. We used a combination of three
                ...
                <li>
                    <div class="redBack imgFromLeft">
                        ...
                        <div style="color: #374047; text-align: right">Creating the possibility of changing the keyboard shortcuts
                            combination for different applications, the ability to add
                    ...
                    <div class="alignRddRight">
                        ...
                        <div class="caseText" style="text-align: right">
                            Stack of technologies:<br/>Qt<br/>Qt Designer<br/>C++<br/>
                            SQLite<br/>X11<br/>Cocoa<br/>WinAPI
                        </div>
                    </div>
                </li>
