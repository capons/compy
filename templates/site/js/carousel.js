...
var isMainPage = (window.location.pathname == "/" || window.location.pathname == "/sourceCi/index.php" || window.location.pathname == "/computools/index.php" || window.location.pathname == "/cmp/index.php" || window.location.pathname == "D:/work/cmp_backlog/30.12 MAIN/home.php" );
...
var isWebPage = (window.location.pathname == "/web-applications/" || window.location.pathname == "/web-applications" || window.location.pathname == "/sourceCi/web_apps.php" || window.location.pathname == "/computools/web_apps.php" || window.location.pathname == "/cmp/web_apps.html" || window.location.pathname == "/cmp/web_apps.php");
...
$(document).ready(function() {
    if(/iPhone|iPad|iPod|Android|BlackBerry|Opera Mini|IEMobile/.test(navigator.appVersion)){
    ...
    windowObj.load(function() {
        ...
        for (var i = 0; i < keyAnchors.length; i++) {
            scrollPositions.push($(keyAnchors[i]).offset().top-50);
        }
    ...
    $('.click_logo').click(function(){
        window.location = "http://computools.com";
    });
    ...
    windowObj.resize(function() {
        ...
        //$('#slider').height(window.innerHeight-1);
    });

    //$('#videoBack').click(function(){
    //$('#videoBack').add('#videoWrapper > img').hide();
    ...
    if(isMainPage) {
        if (documentObj.scrollTop() > 400) {
            intervalID[0] = setInterval(function () {
                ...
                $('.numerics p')[0].innerHTML = numbers[0] + "+"
            }, 80);
            ...
            intervalID[1] = setInterval(function () {
                ...
                $('.numerics p')[1].innerHTML = numbers[1] + "+"
            }, 94);
            ...
            intervalID[2] = setInterval(function () {
                ...
                $('.numerics p')[2].innerHTML = numbers[2] + "+";
            }, 25);
        ...
        if (documentObj.scrollTop() > 700) {
            intervalID[3] = setInterval(function () {
                ...
                $('.numerics p')[3].innerHTML = numbers[3] + "+";
            }, 75);
            ...
            intervalID[4] = setInterval(function () {
                ...
                $('.numerics p')[4].innerHTML = numbers[4];
            }, 375);
            ...
            intervalID[5] = setInterval(function () {
                ...
                $('.numerics p')[5].innerHTML = numbers[5];
            }, 333);
        }
