        ...
        <div class="caseContainer">
            <ul class="caseUl caseUlRdd">
                <li style="text-align: left;">
                    ...
                    <div class="caseText" style="color: #2c3a96;">It is the business card site of the Modzi company, which allows customers finding out the information about the company and directions of the provided IT services, viewing the details of each project that has been implemented by the Modzi workers. Also, on the site you are able to contact with the representatives of the company and discuss all the issues related to the project order.</div>
