...
<head lang="en">
    ...
    <title>HealthKeeper | COMPUTOOLS</title>
...
<h1 style="display: none;">Design - HealthKeeper – Computools</h1><!--For SEO-->
    ...
    <div class="align">
        <div class="caseContainer">
            <ul class="caseUl caseUlRdd">
                <li class="imgFromLeft" style="text-align: left;"><img src="<?=template_url('img');?>cases/healthKeeper/healthKeeper1.png" alt="case image"/></li>
                <li>
                    <div class="bigTitle" style="color: #00acac;">HealthKeeper</div>
                    <div class="caseText" style="text-align: center; color: #fff;">The web application for record keeping and monitoring the condition of patients as well as for gathering and storing the results of analysis and other user medical information. It is also possible to generate the recommendations for the patient and the doctor on the basis of available data.</div>
                </li>
            </ul>
            <div class="hiddenImg"><img src="<?=template_url('img');?>cases/healthKeeper/healthKeeper1.png" alt="case image"/></div>
        </div>
    </div>
</div>
<div id="caseSlide2" class="caseSlide page">
    ...
    <div class="align">
        <div class="caseContainer">
            ...
            <ul class="caseUl caseUlRdd">
                <li><div class="caseText" style="color: #003757;">Storage, viewing and editing the medical data.</div></li>
                <li class="imgFromRight"><img src="<?=template_url('img');?>cases/healthKeeper/healthKeeper2.png" alt="case image"/></li>
            </ul>
        </div>
    </div>
</div>
<div id="caseSlide3" class="caseSlide page" style="background-color: #fff;">
    ...
    <div class="align">
        <div class="caseContainer">
            <ul class="caseUl caseUlRdd">
                <li class="imgFromLeft"><img src="<?=template_url('img');?>cases/healthKeeper/healthKeeper3.png" alt="case image"/></li>
                <li>
                    <div class="caseText" style="color: #efefef;">Connection of the personnel (doctor, nurse) with the patient, and also the possibility of patients transfer.</div>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="caseContainer">
            <ul class="caseUl caseUlRdd">
                <li><div class="caseText" style="color: #003757;">
                        A flexible system for collecting and storing the data of tests (the possibility to correct the values depending on the country).
                    </div></li>
                <li class="imgFromRight"><img src="<?=template_url('img');?>cases/healthKeeper/healthKeeper4.png" alt="case image"/></li>
            </ul>
        </div>
    </div>
</div>
<div id="caseSlide5" class="caseSlide page" style="background-color: #fff;">
    ...
    <div class="align">
        <div class="caseContainer">
            <ul class="caseUl caseUlRdd">
                <li class="imgFromLeft"><img src="<?=template_url('img');?>cases/healthKeeper/healthKeeper5.png" alt="case image"/></li>
                <li>
                    <div class="caseText" style="color: #efefef;">Generation of the recommendations according to the specific algorithms (both for the patient and the doctor).</div>
                </li>
            </ul>
        </div>
    </div>
...
<div id="caseSlide6" class="caseSlide page" style="background-color: #ef7d2d;">
    ...
    <div class="align">
        <div class="caseContainer">
            <ul class="caseUl caseUlRdd">
                <li><div class="caseText" style="color: #003757;">
                        Formation of the anonymous statistics with the possibility of comparing the next categories: doctor-clinic, clinic-state, state-country, etc.
                    </div></li>
                <li class="imgFromRight"><img src="<?=template_url('img');?>cases/healthKeeper/healthKeeper6.png" alt="case image"/></li>
            </ul>
        </div>
    </div>
</div>
<div id="caseSlide7" class="caseSlide page" style="background-color: #fff;">
    ...
    <div class="align">
        <div class="caseContainer">
            <ul class="caseUl caseUlRdd">
                <li class="imgFromLeft"><img src="<?=template_url('img');?>cases/healthKeeper/healthKeeper7.png" alt="case image"/></li>
                <li>
                    <div class="caseText" style="color: #efefef;">
                        Export PDF form data.</div>
                </li>
            </ul>
        </div>
    </div>
...
<div id="caseSlide8" class="caseSlide page" style="background-color: #6ebdb6;">
    ...
    <div class="align">
        <div class="caseContainer">
            ...
            <div class="caseText" style="color: #fff;">Development of the flexible and productive database structure.</div>
        </div>
    </div>
</div>
            ...
            <ul class="caseUl caseUlRdd">
                <li style="text-align: left;">
                    <div class="caseText" style="color: #fff;">
                        Front-end and Back-end are built on ASP .Net.
                    </div>
                    <div class="caseText" style="color: #fff;">
                        <span style="color: #003757;">Front</span> part is the Asp Web site. It has been developed by means of known techniques (Bootstrap, jQuery, etc.). For communication with the server part AJAX is used.
                    </div>
                    <div class="caseText" style="color: #fff;">
                        <span style="color: #003757;">Back-end</span> can send HTML and REST API to the website that allows creating both desktop and mobile client in case of need.To store the data MS SQL Database is used. Also, the project draws on the cloud Microsoft Azure technology.
                    </div>
                </li>
                <li class="imgFromRight" style="text-align: center;"><img src="<?=template_url('img');?>cases/healthKeeper/healthKeeper8.png" alt="case image"/></li>
            </ul>
...
<div id="caseSlide10" class="caseSlide page" style="padding-top: 0; background-color: #003757;">
    ...
    <div class="align">
        <div class="caseContainer">
            ...
            <ul class="caseUl caseUlRdd">
                <li class="imgFromLeft" style="text-align: center;"><img src="<?=template_url('img');?>cases/healthKeeper/healthKeeper9.png" alt="case image"/></li>
                <li style="text-align: left;">
