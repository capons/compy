var body=$("body");$(document).on({ajaxStart:function(){body.addClass("loading")},ajaxStop:function(){body.removeClass("loading")}});$(document).on("click",function(){$.get("/mockjax")});
/*!
